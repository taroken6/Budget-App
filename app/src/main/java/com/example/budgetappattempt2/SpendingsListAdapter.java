...
public class SpendingsListAdapter extends BaseExpandableListAdapter {
    private final DecimalFormat DECI_FORMAT = new DecimalFormat("0.00");
    Context context;
    List<String> header;
    Map<String, List<SpendingsListObject>> map; // Header is key.

    public SpendingsListAdapter(Context context, List<String> header, Map<String, List<SpendingsListObject>> map) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.spendings_table_header, null);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        SpendingsListObject child = (SpendingsListObject) getChild(groupPosition, childPosition);
        if(convertView == null){
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
